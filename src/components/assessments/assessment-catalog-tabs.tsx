        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "cursor-pointer inline-flex h-10 items-center justify-center rounded-lg px-4 text-sm tracking-[0.016em] transition-all duration-300 hover:-translate-y-0.5 sm:min-w-48.25 sm:px-6 sm:text-base",
                isActive
